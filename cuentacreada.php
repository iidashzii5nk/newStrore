...
<div class="principalctn">
	<div class="secundarioctn">
		<div class="homen">
			<div class="aut">
				<a href="index.php">
		...
		<div class="creacuent">
			<h1>Mi cuenta</h1>
			<p>Bienvenido a tu cuenta. Desde aqui puedes administrar tus direcciones y pedidos</p>
				<div class="sbcreacnt">
					<div class="cntcuenta">
							...
							<ul>
								...
								<li>
									<a href="">
									<i class="cuaderno fas fa-edit"></i>
									<span>HISTORIAL Y DETALLES DE MIS PEDIDOS</span>
									</a>
								</li>
								<li>
									<a href="">
									<i class="vales fas fa-list-alt"></i>
									<span>MIS VALES DESCUENTO</span>
									</a>
								</li>
								<li>
									<a href="">
								...
								<li>
									<a href="">
									<i class="datos fas fa-address-card"></i>
						...
						<div class="ctnmenu2">
							...
							<li>
								...
								<li>
									<a href="">
									<i class="alerta fas fa-envelope"></i>
									<span>MIS ALERTAS</span>
									</a>
								</li>
								<li>
									<a href="">
									<i class="puntos fas fa-hand-holding-medical"></i>
									<span>MIS PUNTOS 3BPTATTOO</span>
									</a>
								</li>	
								</ul>
					</div>				
